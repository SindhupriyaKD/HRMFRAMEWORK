...
//		driver.findElement(By.xpath("//td[text()='"+acName+"']/..//i[@title='Edit Employee']")).click();
		...
		WebElement email = driver.findElement(By.xpath("//h4[text()='Edit Admin']/../..//input[@name='hr_email']"));
		 email.clear();
		 email.sendKeys("qsphead222@gmail.com");
		WebElement pass = driver.findElement(By.xpath("//h4[text()='Edit Admin']/../..//input[@name='hr_password']"));
		pass.clear();
		pass.sendKeys("12345678");
        driver.findElement(By.xpath("//input[@value='QSP']/../../../../..//button[text()='Save']")).click();
		//popup for sucessfully
		...
		driver.findElement(By.xpath("//label[text()='Search:']")).sendKeys("qsp");
		List<WebElement> names = driver.findElements(By.xpath("//tbody/tr/td[2]"));
		 flag=false;
		for (WebElement name : names) {
			if (name.equals("qsp")) {
				System.out.println("Searched admin details displayed and verified upon the admin name");
				flag=true;
				break;
				
			}
			if (!flag) {
				System.out.println("Searched admin detail is not displayed and verified upon the admin name");
			}
		}
		 ...
		 */
		//login to the application
		driver.findElement(By.name("hr_email")).sendKeys("qsphead222@gmail.com");
		driver.findElement(By.name("hr_password")).sendKeys("12345678");
